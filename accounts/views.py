    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            try:
                ...
                messages.error(
                    request,
                    'No se pudo enviar el correo de activación. Reinicia el servidor '
                    '(python manage.py runserver) y verifica la App Password de Gmail en .env.',
                )
                return redirect('register')
            except Exception:
                messages.error(
                    request,
                    'No se pudo enviar el correo de activación. Intenta de nuevo en unos minutos.',
                )
                return redirect('register')
