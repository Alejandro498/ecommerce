...
ARCHIVO_ENTRADA = os.path.join(CARPETA, "cpu-cooler-123.csv")
ARCHIVO_SALIDA = os.path.join(CARPETA, "cpu-cooler-1000.csv")
TAMANO_OBJETIVO = 1000
SEMILLA = 20260916
COLUMNAS_ESTRATO = ["cooler_type", "_radiator_size_estrato", "brand", "price_available"]
...
df["_radiator_size_estrato"] = df["radiator_size"].fillna(0)
...
resultado = resultado.drop(columns=["_radiator_size_estrato"])
